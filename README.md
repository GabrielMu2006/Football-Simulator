...
如果要把新构建的 macOS 版本同步到仓库发布目录：

```bash
mkdir -p release/macos
ditto "dist-ui-v2/Football-Simulator-UI-v2-macOS" "release/macos/Football-Simulator-UI-v2-macOS"
cp "Football-Simulator-UI-v2-macOS.zip" "release/macos/Football-Simulator-UI-v2-macOS.zip"
```
...
release/
  macos/               macOS 可运行版与 zip
    Open Football Simulator UI v2.command
