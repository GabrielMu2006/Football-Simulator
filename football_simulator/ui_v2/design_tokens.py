...
# -- 位置/状态/分区徽标（widgets.py 迁移） ----------------------------------
POSITION_GK_COLOR = "#7dd3fc"
POSITION_DF_COLOR = "#86efac"
POSITION_MF_COLOR = "#facc15"
POSITION_FW_COLOR = "#fb7185"

STATUS_PREMIER_COLOR = "#8ec5ff"
STATUS_SECOND_COLOR = "#9ae6b4"
STATUS_CUP_COLOR = "#f9c74f"
STATUS_PENDING_COLOR = "#fca5a5"
STATUS_DONE_COLOR = "#a7f3d0"
STATUS_ACTIVE_COLOR = "#93c5fd"
STATUS_DISABLED_COLOR = "#94a3b8"

ZONE_CHAMPION_BG = "#173d32"
ZONE_PROMOTION_BG = "#153a30"
ZONE_PLAYOFF_BG = "#3a3217"
ZONE_RELEGATION_BG = "#3b1f2a"
ZONE_CURRENT_BG = "#18355a"

BADGE_DEFAULT_COLOR = "#94a3b8"
STATUS_NOT_HELD_FG = "#64748b"
STATUS_NOT_HELD_BG = "#101828"

# 赛季时间线周次着色（season_overview_page）
WEEK_WINTER_BG = "#26381f"
WEEK_SUMMER_BG = "#342a1d"
WEEK_PLAYOFF_BG = "#3a3217"
WEEK_CUP_BG = "#2c2543"
WEEK_LEAGUE_BG = "#16233a"
WEEK_PLAYED_BG = "#18355a"
WEEK_CURRENT_BG = "#1d4f8f"
